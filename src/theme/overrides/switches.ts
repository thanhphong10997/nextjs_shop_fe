      ...
      styleOverrides: {
        root: ({ theme }: OwnerStateThemeType) => ({
          ...
          '& .MuiSwitch-track': {
            ...
            border: `1px solid ${theme.palette.customColors.main}${theme.palette.mode === 'dark' ? '66' : '33'}`,
            transition:
        ...
        switchBase: ({ theme }: OwnerStateThemeType) => ({
          ...
          color: `${theme.palette.customColors.main}${theme.palette.mode === 'dark' ? '66' : '33'}`,
          '&:hover': {
            backgroundColor: 'transparent !important'
          },
          '&.Mui-disabled': {
            color: `${theme.palette.customColors.main}${theme.palette.mode === 'dark' ? 'cc' : '66'}`,
            '& + .MuiSwitch-track': {
              borderColor: 'transparent !important',
              backgroundColor: `${theme.palette.customColors.main}${theme.palette.mode === 'dark' ? '66' : '33'}`
            },
            '&, & + .MuiSwitch-track': {
              opacity: 0.5
            },
